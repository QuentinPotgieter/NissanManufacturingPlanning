...
namespace NissanManufacturingPlanning
{
    public partial class MainForm : Form
    {
        ...
        public void QuerySelectAll(string table, DataGridView dgv)
        {
            try
            {
                conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\louis\source\repos\QuentinPotgieter\NissanManufacturingPlanning\NissanManufacturingDB.mdf;Integrated Security=True");
                conn.Open();
